package com.delightlane.keyboard.hangul;

import com.delightlane.keyboard.layout.LayoutSymbol;
import com.delightlane.keyboard.view.DefaultSoftKeyboard;

import static com.delightlane.keyboard.layout.Layout12KeyDubul.COMB_DUBUL_12KEY_CHEONJIIN;
import static com.delightlane.keyboard.layout.Layout12KeyDubul.COMB_DUBUL_12KEY_NARATGEUL;
import static com.delightlane.keyboard.layout.Layout12KeyDubul.COMB_DUBUL_12KEY_SKY2;
import static com.delightlane.keyboard.layout.Layout12KeyDubul.CYCLE_DUBUL_12KEY_CHEONJIIN;
import static com.delightlane.keyboard.layout.Layout12KeyDubul.CYCLE_DUBUL_12KEY_NARATGEUL;
import static com.delightlane.keyboard.layout.Layout12KeyDubul.CYCLE_DUBUL_12KEY_SKY2;
import static com.delightlane.keyboard.layout.Layout12KeyDubul.STROKE_DUBUL_12KEY_NARATGEUL;
import static com.delightlane.keyboard.layout.Layout12KeySebul.COMB_SEBUL_12KEY_HANSON;
import static com.delightlane.keyboard.layout.Layout12KeySebul.COMB_SEBUL_12KEY_MUNHWA;
import static com.delightlane.keyboard.layout.Layout12KeySebul.COMB_SEBUL_12KEY_SENA;
import static com.delightlane.keyboard.layout.Layout12KeySebul.CYCLE_SEBUL_12KEY_HANSON;
import static com.delightlane.keyboard.layout.Layout12KeySebul.CYCLE_SEBUL_12KEY_MUNHWA;
import static com.delightlane.keyboard.layout.Layout12KeySebul.CYCLE_SEBUL_12KEY_SENA;
import static com.delightlane.keyboard.layout.Layout12KeySebul.STROKE_SEBUL_12KEY_HANSON;
import static com.delightlane.keyboard.layout.Layout12KeySebul.STROKE_SEBUL_12KEY_MUNHWA;
import static com.delightlane.keyboard.layout.Layout12KeySebul.STROKE_SEBUL_12KEY_SENA;
import static com.delightlane.keyboard.layout.LayoutAlphabet.CONVERT_ENGLISH_COLEMAK;
import static com.delightlane.keyboard.layout.LayoutAlphabet.CONVERT_ENGLISH_DVORAK;
import static com.delightlane.keyboard.layout.LayoutAlphabet.CYCLE_12KEY_ALPHABET_A;
import static com.delightlane.keyboard.layout.LayoutAlphabet.CYCLE_12KEY_ALPHABET_B;
import static com.delightlane.keyboard.layout.LayoutAlphabet.CYCLE_12KEY_ALPHABET_SMALLQWERTY;
import static com.delightlane.keyboard.layout.LayoutDev.COMB_NEBUL_1969;
import static com.delightlane.keyboard.layout.LayoutDev.JAMO_NEBUL_1969;
import static com.delightlane.keyboard.layout.LayoutDubul.COMB_DUBUL_DANMOEUM_GOOGLE;
import static com.delightlane.keyboard.layout.LayoutDubul.COMB_DUBUL_STANDARD;
import static com.delightlane.keyboard.layout.LayoutDubul.JAMO_DUBUL_DANMOEUM_GOOGLE;
import static com.delightlane.keyboard.layout.LayoutDubul.JAMO_DUBUL_NK;
import static com.delightlane.keyboard.layout.LayoutDubul.JAMO_DUBUL_STANDARD;
import static com.delightlane.keyboard.layout.LayoutDubul.JAMO_DUBUL_YET;
import static com.delightlane.keyboard.layout.LayoutGongSebul.COMB_FULL;
import static com.delightlane.keyboard.layout.LayoutGongSebul.COMB_SEBULSIK;
import static com.delightlane.keyboard.layout.LayoutGongSebul.COMB_SEBUL_DANMOEUM;
import static com.delightlane.keyboard.layout.LayoutGongSebul.COMB_SEBUL_SUN_2014;
import static com.delightlane.keyboard.layout.LayoutGongSebul.JAMO_SEBUL_390;
import static com.delightlane.keyboard.layout.LayoutGongSebul.JAMO_SEBUL_391;
import static com.delightlane.keyboard.layout.LayoutGongSebul.JAMO_SEBUL_393Y;
import static com.delightlane.keyboard.layout.LayoutGongSebul.JAMO_SEBUL_DANMOEUM;
import static com.delightlane.keyboard.layout.LayoutGongSebul.JAMO_SEBUL_SUN_2014;
import static com.delightlane.keyboard.layout.LayoutMoachigiSebul.COMB_SEBUL_AHNMATAE;
import static com.delightlane.keyboard.layout.LayoutMoachigiSebul.COMB_SEBUL_SEMOE;
import static com.delightlane.keyboard.layout.LayoutMoachigiSebul.JAMO_SEBUL_AHNMATAE;
import static com.delightlane.keyboard.layout.LayoutMoachigiSebul.JAMO_SEBUL_SEMOE_2016;
import static com.delightlane.keyboard.layout.LayoutShinSebul.COMB_SEBUL_3_2015;
import static com.delightlane.keyboard.layout.LayoutShinSebul.COMB_SEBUL_3_P3;
import static com.delightlane.keyboard.layout.LayoutShinSebul.COMB_SEBUL_SHIN_ORIGINAL;
import static com.delightlane.keyboard.layout.LayoutShinSebul.JAMOSET_SEBUL_3_2015;
import static com.delightlane.keyboard.layout.LayoutShinSebul.JAMOSET_SEBUL_3_2015M;
import static com.delightlane.keyboard.layout.LayoutShinSebul.JAMOSET_SEBUL_3_P3;
import static com.delightlane.keyboard.layout.LayoutShinSebul.JAMOSET_SHIN_EDIT;
import static com.delightlane.keyboard.layout.LayoutShinSebul.JAMOSET_SHIN_M;
import static com.delightlane.keyboard.layout.LayoutShinSebul.JAMOSET_SHIN_ORIGINAL;
import static com.delightlane.keyboard.layout.LayoutShinSebul.JAMOSET_SHIN_P2;
import static com.delightlane.keyboard.layout.LayoutShinSebul.JAMO_SEBUL_3_2015Y;
...
public enum EngineMode {
	...
	TWELVE_DUBUL_NARATGEUL				(new Properties(true, false, false),
			CYCLE_DUBUL_12KEY_NARATGEUL, null, COMB_DUBUL_12KEY_NARATGEUL, STROKE_DUBUL_12KEY_NARATGEUL,
			"keyboard_12key_dubul_naratgeul", "keyboard_12key_dubul_naratgeul_center"),
